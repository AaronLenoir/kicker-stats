defmodule GameStats.Collectors.TeamTest do
  ...
  test "winning team should receive a 416 rating" do
    {_, stats} =
      [
        "01/01/2023;keeperA;strikerA;10;0;keeperB;strikerB"
      ]
    ...
    assert stats.rating_by_team["keeperA - strikerA"] == 416
  end

  test "losing team should receive a 384 rating" do
    {_, stats} =
      [
        "01/01/2023;keeperA;strikerA;10;0;keeperB;strikerB"
      ]
    ...
    assert stats.rating_by_team["keeperB - strikerB"] == 384
  end

  test "twice winning team should receive a 431 rating" do
    {_, stats} =
      [
        "01/01/2023;keeperA;strikerA;10;0;keeperB;strikerB",
        "01/01/2023;keeperA;strikerA;10;0;keeperB;strikerB",
    ...
    assert stats.rating_by_team["keeperA - strikerA"] == 431
  end
end
